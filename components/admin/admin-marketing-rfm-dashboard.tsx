...
export default function AdminMarketingRfmDashboard() {
  ...
  useEffect(() => {
    if (!selected) { setDetail(null); setBehavior(null); setCustomers(null); return; }
    const controller = new AbortController();
    setDetailLoading(true); setError(''); setBehavior(null); setCustomers(null);
